...
-- 50 : 30 sceau conf�rie : choix entre clotho et lach�sis
-- 24 : Apr�s achat d'un orb (qu'bia, yughott, palborough, giddeus)
-- 8 : Apr�s achat d'un orb (yughott, palborough, giddeus, qu'bia, ghelsba)
-- 4 : Apr�s achat d'un orb (yughott, palborough, giddeus, ghelsba)
-- 10 : Apr�s achat d'un orb (yughott, palborough, giddeus)
...
-- 22 : Trade d'un orb utilis� (il le recup)
-- 25 : Un seul �change autoris� par semaine
