...
function pickItem(player, info)
    ...
    if item == 769 then
        item = rocks[VanadielDayOfTheWeek() + 1]
    --end
end
...
local function setEleOre(day)
	...
	if (math.random(1,10) == 7) then -- 10% chance
		ret = 1254 + math.random(1,8); -- select a random ore
	end
