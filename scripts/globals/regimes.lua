        ...
        zone =
        {
            ...
            [tpz.zone.RANGUEMONT_PASS] =
            {
                ...
                page =
                {
                    ...
                    { 3, 3, 0, 0, 33, 35, 1100, 608},
                    { 5, 2, 0, 0, 32, 36, 1210, 607},
                    { 3, 3, 0, 0, 34, 37, 1310, 609},
                },
            },
            ...
            [tpz.zone.DANGRUF_WADI] =
            {
                ...
                page =
                {
                    ...
                    { 4, 2, 0, 0, 12, 16, 520, 642},
                    { 5, 2, 0, 0, 14, 18, 560, 643},
                    { 5, 2, 0, 0, 14, 19, 650, 644},
                    { 2, 2, 2, 0, 17, 23, 710, 645},
                    { 5, 2, 0, 0, 20, 26, 840, 646},
                },
            },
            [tpz.zone.INNER_HORUTOTO_RUINS] =
            {
                ...
                page =
                {
                    { 2, 3, 0, 0,  1,  6, 250, 647},
                    { 2, 3, 0, 0,  1,  7, 270, 648},
                    { 3, 3, 0, 0, 12, 15, 510, 652},
                    { 3, 2, 0, 0, 15, 20, 560, 649},
                    { 3, 3, 0, 0, 14, 23, 650, 651},
                    { 4, 2, 0, 0, 22, 26, 840, 650},
                    { 2, 4, 0, 0, 23, 25, 910, 653},
                    { 2, 4, 0, 0, 25, 28, 970, 654},
                },
            },
            [tpz.zone.ORDELLES_CAVES] =
            {
                ...
                page =
                {
                    { 3, 3, 0, 0, 17, 19, 610, 661},
                    { 3, 3, 0, 0, 18, 21, 730, 655},
                    { 3, 3, 0, 0, 18, 21, 790, 662},
            ...
            [tpz.zone.OUTER_HORUTOTO_RUINS] =
            {
                ...
                page =
                {
                    ...
                    { 5, 1, 0, 0, 22, 25, 550, 669},
                    { 5, 1, 0, 0, 23, 27, 570, 670},
            ...
            [tpz.zone.GUSGEN_MINES] =
            {
                ...
                page =
                {
                    ...
                    { 2, 5, 0, 0, 29, 31, 1120, 685},
                    { 2, 5, 0, 0, 31, 33, 1230, 686},
                    { 3, 3, 0, 0, 30, 34, 1300, 683},
            ...
            [tpz.zone.CRAWLERS_NEST] =
            {
                ...
                page =
                {
                    ...
                    { 4, 3, 0, 0, 57, 61, 1410, 693},
                    { 3, 3, 0, 0, 59, 63, 1470, 692},
                    { 4, 3, 0, 0, 60, 64, 1520, 694},
                },
            },
            [tpz.zone.MAZE_OF_SHAKHRAMI] =
            {
                ...
                page =
                {
                    ...
                    { 3, 3, 0, 0, 23, 26, 870, 701},
                    { 3, 3, 0, 0, 25, 31, 900, 702},
