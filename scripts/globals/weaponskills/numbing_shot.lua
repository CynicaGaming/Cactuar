...
function onUseWeaponSkill(player, target, wsID, tp, primary, action, taChar)
    ...
    params.str_wsc = 0.0 params.dex_wsc = 0.0 params.vit_wsc = 0.0 params.agi_wsc = 0.5 params.int_wsc = 0.0 params.mnd_wsc = 0.0 params.chr_wsc = 0.0
    ...
    if weaponType == tpz.skill.HAND_TO_HAND or weaponType == tpz.skill.NONE then
        ...
        weaponDamage = player:getWeaponDmg()
	end
