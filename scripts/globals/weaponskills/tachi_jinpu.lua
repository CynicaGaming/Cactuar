...
function onUseWeaponSkill(player, target, wsID, tp, primary, action, taChar)
    ...
    local params = {}
    params.numHits = 2
    params.ftp100 = 0.35 params.ftp200 = 0.50 params.ftp300 = 0.75
    params.str_wsc = 0.3 params.dex_wsc = 0.0 params.vit_wsc = 0.0 params.agi_wsc = 0.0 params.int_wsc = 0.45 params.mnd_wsc = 0.0 params.chr_wsc = 0.0
