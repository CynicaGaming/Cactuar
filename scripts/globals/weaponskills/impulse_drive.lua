...
function onUseWeaponSkill(player, target, wsID, tp, primary, action, taChar)
    ...
    local params = {}
    params.numHits = 2
    params.ftp100 = 1 params.ftp200 = 2.75 params.ftp300 = 5.5
    params.str_wsc = 0.9 params.dex_wsc = 0.0 params.vit_wsc = 0.0 params.agi_wsc = 0.0 params.int_wsc = 0.0 params.mnd_wsc = 0.0 params.chr_wsc = 0.0
