...
function onUseWeaponSkill(player, target, wsID, tp, primary, action, taChar)
    ...
    local params = {}
    params.ftp100 = 1.25 params.ftp200 = 2.6 params.ftp300 = 4
    params.str_wsc = 0.4 params.dex_wsc = 0.0 params.vit_wsc = 0.0 params.agi_wsc = 0.0 params.int_wsc = 0.0 params.mnd_wsc = 0.6 params.chr_wsc = 0.0
