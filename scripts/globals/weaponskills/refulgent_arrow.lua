...
function onUseWeaponSkill(player, target, wsID, tp, primary, action, taChar)
    ...
    local params = {}
    params.numHits = 2
    params.ftp100 = 2 params.ftp200 = 4.25 params.ftp300 = 7
    params.str_wsc = 0.5 params.dex_wsc = 0.0 params.vit_wsc = 0.0 params.agi_wsc = 0.25 params.int_wsc = 0.0 params.mnd_wsc = 0.0 params.chr_wsc = 0.0
