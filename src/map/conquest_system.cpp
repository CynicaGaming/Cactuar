...
namespace conquest
{
    ...
    ************************************************************************/
    ...
    /************************************************************************
    *                                                                       *
    *  Remaining number of days until conquest tally                        *
    *                                                                       *
    ************************************************************************/

    uint8 GetNexTally()
    {
        auto weekday = CVanaTime::getInstance()->getJstWeekDay();
        uint8 dayspassed = (weekday == 0 ? 6 : weekday - 1) * 25;
        dayspassed += ((CVanaTime::getInstance()->getJstHour() * 60 + CVanaTime::getInstance()->getJstMinute()) * 25) / 1440;
    ...
    ************************************************************************/
    ...
    /************************************************************************
    *                                                                       *
    *  Find nation that owns the specified region                           *
    *                                                                       *
    ************************************************************************/
	...
	/************************************************************************
    *                                                                       *
    *  Add conquest points to character based on experience gained          *
    *                                                                       *
    ************************************************************************/
