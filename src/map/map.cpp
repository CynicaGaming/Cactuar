...
int32 map_config_default()
{
    ...
    map_config.automaton_skillup_chance_multiplier = 1.0f; // Cactuar
    map_config.automaton_skillup_amount_multiplier = 1; // cactuar
    ...
    while (fgets(line, sizeof(line), fp))
    {
        ...
        *ptr = '\0';
        ...
        if (!knownSetting)
        {
            ...
            else if (strcmp(w1, "automaton_skillup_chance_multiplier") == 0)
            {
                map_config.automaton_skillup_chance_multiplier = (float)atof(w2);
            }
            else if (strcmp(w1, "automaton_skillup_amount_multiplier") == 0)
            {
                map_config.automaton_skillup_amount_multiplier = (float)atof(w2);
            }
            else
            {
