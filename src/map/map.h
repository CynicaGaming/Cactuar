...
struct map_config_t
{
    ...
    float  automaton_skillup_chance_multiplier;  // Constant used in the skillup formula that has a strong effect on skill-up rates for puppets. Cactuar Custom Umeboshi
    float  automaton_skillup_amount_multiplier;  // Used to increase the amount of skill gained during skill up for puppets. Cactuar Custom Umeboshi
